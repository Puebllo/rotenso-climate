...
namespace esphome
{
  namespace rotenso
  {
    ...
    private:
      ...
      void set_fan_speed(climate::ClimateFanMode fan_mode, bool vertical_swing_moving);
      void set_swing_mode(climate::ClimateSwingMode swing, climate::ClimateFanMode fan_mode);
    };
